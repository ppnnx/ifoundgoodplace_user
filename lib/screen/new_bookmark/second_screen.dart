...
import 'package:ifgpdemo/screen/new_bookmark/bookmark_detail_screen.dart';
import 'package:ifgpdemo/widget/refresh/refresh_widget.dart';
  ...
  Future<List<SaveModel>?> fetchSaveList() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('API SHOW BOOKMARK LIST FAILED');
      }
    } catch (e) {}
    return null;
  }

  Future refreshbookmarked() async {
    await Future.delayed(Duration(milliseconds: 2000));
    fetchSaveList().then((value) {
      setState(() {});
    });
  }
